...
var key_str : String = "ItemTranslation":
	set = _key_str_txt_changed
var orig_txt : String = "Original Text":
	set = _orig_txt_changed
var trans_txt : String = "Text Translated":
	set = update_trans_txt
...
func _on_LineEditTranslation_text_submitted(_new_text: String) -> void:
